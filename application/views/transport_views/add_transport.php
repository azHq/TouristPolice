...
<body>
    ...
    <?php if($this->session->flashdata('result')){ ?>
        <div class="mt-3 w-100">
            <div class="alert alert-info w-50 m-auto" style="text-align:center;"> <?php echo $this->session->flashdata('result') ?></div>
        </div>
    	...
    	<div class="row m-5 card" style="border-radius:10px;padding:20px">
    		...
    		<form action="" method="POST" class="m-auto w-75">
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="pic" required="text" class="btn btn-info btn-sm w-100" style="margin-left:-2px; border-radius:10px">
            </div>
               
                <div class="w-100 form-group">
                	<button type="submit" name="submit" class="btn-md btn-primary form-control w-100" style="height:40px;border-radius:6px;width:120px">Submit</button>
                </div>
