                                ...
                                <div class="w-50 mr-4 mt-4 ml-auto d-flex justify-content-end" style="border-radius:12px">
                                    ...
                                    <div>
                                     ...
                                     <div class="container w-75 d-flex justify-content-end">
                                            <button  class="btn btn-primary btn-sm" style="border-radius:10px;font-weight:bold;" onclick="showRatingForm()" href="">Write Answer</button>
                                            <input type="number" id="question_id" hidden="true" value="<?php  echo $value->id ?>">
                                    </div>
                                   </div> 
        ...
        <div  class="w-75 m-auto card p-4" style="border-radius:10px">
            <div onclick="hideForm()" class="form-group d-flex justify-content-end" >
             ...
             <div class="form-group">
                <label style="font-family:serif;">Write Your Answer</label>
    ...
    <script type="text/javascript">
        ...
        function submitRating(){
            ...
            if(answer.length>=2){
                ...
                alert('fail to upload.please write your answer.');
            }
